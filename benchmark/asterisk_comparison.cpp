...
// CHANGES: Added symmetrical layer of additions after each multiplication layer
...
// CHANGES: Removed unused generateCircuitwM3, generateCircuitwM4
...
void benchmark(const bpo::variables_map& opts) {
    ...
    json output_data;
    // CHANGES: Included number of bits of number representation.
    ...
    for (size_t r = 0; r < repeat; ++r) {
        // CHANGES: Separately measure setup and online
